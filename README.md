...
4. [Transform 坐标变换](./transform.md) — TF 是什么、rm-controls 怎么处理 TF
5. [Chassis 底盘](./chassis.md) — 车是怎么动起来的：轮系、功率、FOLLOW、里程计
6. [Gimbal 云台](./gimbal.md) — 是怎么瞄准的：串级 PID、重力补偿、弹道、自瞄
7. [Shooter 发射](./shooter.md) — 子弹是怎么打出去的：摩擦轮、状态机、卡弹、热量
8. [Manual 决策层](./manual.md) — 上层怎么编排下层：事件、控制器切换、标定编排、指令发布
